...
export default function Introduction({introduction, errors}) {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        router.post(_route("admin.landing-page.updateIntroduction"), {...data, _method: "PUT"}, {
            onSuccess: () => {
                saySomething();
            },
        });
        ...
        <Container>
            ...
            items={[
                ...
                },
                {
                    ...
                    href: _route("admin.introduction.show-introduction"),
                    current: true,
                },
            ]}
            />
...
Introduction.layout = (page) => <Master children={page} />;
