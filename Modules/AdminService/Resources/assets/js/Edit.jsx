...
export default function Edit({ service, referer, errors }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        router.post(_route("admin.service.update", data.id), {...data,
            _method : 'PUT'
        }, {
            onSuccess: () => {
                saySomething();
            ...
            <Container>
                <Breadcrumb
                    ...
                    items={[
                        ...
                        {
                            name: __("Edit"),
                            href: _route("admin.service.edit", data),
                            current: true,
                        },
                    ]}
                />
                    ...
                    <Grid.Span1>
                        ...
                        onSubmit={handleSubmit}>
                            <Card>
                                <Card.Header>
                                    <Card.Title>
                                    <Card.TitleText className="text-2xl mb-0">{__('Service Edit Form')}</Card.TitleText>
