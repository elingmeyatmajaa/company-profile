...
export default function Edit({ aboutPoints, referer, errors }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        router.post(_route("admin.about-point.update", data.id), {...data,
            _method : 'PUT'
        }, {
            onSuccess: () => {
                saySomething();
            ...
            <Container>
                <Breadcrumb
                    ...
                    items={[
                        ...
                        {
                            name: __("Edit"),
                            href: _route("admin.about-point.edit", data),
                            current: true,
                        },
                    ]}
                />
                    ...
                    <Grid.Span1>
                        ...
                        onSubmit={handleSubmit}>
                            <Card>
                                <Card.Header>
                                    <Card.Title>
                                    <Card.TitleText className="text-2xl mb-0">{__('About Point Edit Form')}</Card.TitleText>
